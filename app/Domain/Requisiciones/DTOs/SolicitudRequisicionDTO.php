...
class SolicitudRequisicionDTO
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'unidad_organizativa_id' => $this->unidadOrganizativaId,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            unidadOrganizativaId: isset($data['unidad_organizativa_id']) ? (int) $data['unidad_organizativa_id'] : null,
            requisicionPadreId: isset($data['requisicion_padre_id']) ? (int) $data['requisicion_padre_id'] : null,
    ...
    public function withEstado(SolicitudRequisicionEstadoEnum $estado): self
    {
        return new self(
            ...
            unidadOrganizativaId: $this->unidadOrganizativaId,
            requisicionPadreId: $this->requisicionPadreId,
            observaciones: $this->observaciones,
            estado: $estado,
            accion: $this->accion,
